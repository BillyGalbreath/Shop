...
public class ShopMessage {
    ...
    public static String formatMessage(String unformattedMessage, AbstractShop shop, Player player, boolean forSign) {
        ...
        if (shop != null) {
            if (shop.isAdmin()) {
                unformattedMessage = unformattedMessage.replace("[owner]", Bukkit.getServerName());
            } else {
            ...
            unformattedMessage = unformattedMessage.replace("[shop type]", "" + getCreationWord(shop.getType().toString().toUpperCase()));
        ...
        unformattedMessage = unformattedMessage.replace("[server name]", Bukkit.getServerName());
        if (forSign) {
